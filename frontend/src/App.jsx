...
export default function App() {
  ...
  const renderTab = () => {
    ...
    switch (tab) {
      ...
      case 'pending':
        return <Pending tasks={tasks.filter(t => t.status !== 'completed')} setStatus={setStatus} setComment={setComment} removeTask={removeTask} />
      case 'completed':
...
// ---------- Pending overview ----------
function Pending({ tasks, setStatus, setComment, removeTask }) {
